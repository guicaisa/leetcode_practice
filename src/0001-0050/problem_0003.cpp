...
public:
	...
	int LengthOfLongestSubstringSlideWindow(const std::string& s)
	{
	...
	int LengthOfLongestSubstringSlideWindow2(const std::string& s)
	{
		std::unordered_map<char, int> char_to_index;
		int max_length = 0;
	...
	int LengthOfLongestSubstringSlideWindow3(const std::string& s)
	{
